...
#Chart 1
plot(data1$DateTime,data1$Global_active_power,ylab="Global Active Power",xlab="",lwd=1,type="l")
...
#Chart 4
plot(data1$DateTime,data1$Global_reactive_power,ylab="Global_reactive_power",xlab="datetime",lwd=1,type="l")
